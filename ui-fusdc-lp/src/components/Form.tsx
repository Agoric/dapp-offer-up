const Form = () => (
  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
    <div className="card bg-white shadow p-4">
      ...
      <button className="btn btn-error w-full mt-4 bg-[#cd4246] text-white h-8 rounded">Deposit</button>
    </div>
    ...
    <div className="card bg-white shadow p-4">
      ...
      <button className="btn btn-error w-full bg-[#cd4246] text-white h-8 rounded">Withdraw</button>
    </div>
  </div>
);
